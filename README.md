...
В проект интегрирована демонстрационная система серверного трекинга событий (**Server-Side Tracking**) для отправки e-commerce метрик в **Yandex Metrica** по официальной спецификации протокола **Measurement Protocol**.
